create database RH;
CREATE ROLE rh LOGIN PASSWORD 'rh';
ALTER DATABASE rh OWNER TO rh;
...
CREATE OR REPLACE VIEW listeEmploye As 
select employee.nom,poste.nomposte,contrat.typecontrat from employee join poste on 
employee.idposte = poste.idposte 
join contrat on employee.idcontrat = contrat.idcontrat;